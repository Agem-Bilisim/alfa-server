...
![alt text](img/yazilim_envanteri.png "Yazılım Envanter")
...
![alt text](img/yazilim_duzenle.png "Yazılım Düzenle")
...
![alt text](img/hizmet_listesi.png "Hizmet Listesi")
...
![alt text](img/yazilim_sorunlar.png "Sorunlar Listesi")
...
![alt text](img/sorun_duzenle.png "Sorun Düzenle")
...
![alt text](img/sorun_surec_baslat.png "Süreç Başlat")
...
![alt text](img/donanim_envanteri.png "Donanım Envanteri")
...
![alt text](img/islemci_duzenle.png "İşlemci Düzenle")

Grafik kart listesinde; ekran kartına ait Altsistem, Bellek, Kernel bilgileri mevcuttur.

![alt text](img/grafik_kart.png "Grafik Düzenle")
...
![alt text](img/disk_duzenle.png "Disk Düzenle")
...
![alt text](img/bellek_duzenle.png "Bellek Düzenle")
...
![alt text](img/bios.png "BIOS Listesi")
...
![alt text](img/network.png "Network Düzenle")
...
![alt text](img/donanim_sorunlar.png "Donanım Sorunlar")
...
![alt text](img/donanim_sorun_duzenle.png "Donanım Sorun Düzenle")

**Süreç Başlat** işleminde de soruna ait Sorumlu Rol, Açıklama, Tahmini Bitiş Tarihi ve Notlar bilgileri doldurulduktan sonra, **Başlat** butonuna basılarak süreç başlatılır.

![alt text](img/donanim_sorun_surec_baslat.png "Donanım Süreç Başlat")

### Çevresel Cihazlar

Çevresel cihazlar listesi; bilgisayarın dışından bilgi almak için kullanılan yardımcı cihazların listesidir.

![alt text](img/cevresel_cihazlar.png "Çevresel Cihazlar Listesi")
...
![alt text](img/cevresel_cihazlar_duzenle.png "Çevresel Cihazlar Düzenle")
...
![alt text](img/cevresel_sorunlar.png "Çevresel Cihazlar Sorunlar")
...
![alt text](img/cevresel_cihaz_sorun_duzenle.png "Çevresel Cihaz Sorun Düzenle")

**Süreç Başlat** işleminde de soruna ait Sorumlu Rol, Açıklama, Tahmini Bitiş Tarihi ve Notlar bilgileri doldurulduktan sonra, **Başlat** butonuna basılarak süreç başlatılır.

![alt text](img/cevresel_sorun_surec_baslat.png "Çevresel Cihaz Sorun Süreç Başlat")
...
![alt text](img/organizasyon_senkronize.png "Organizasyon Senkronize Et")
...
![alt text](img/egitimler.png "Eğitimler Listesi")
...
![alt text](img/sorunlar.png "Sorunlar Listesi")
...
![alt text](img/anket.png "Anket Listesi")
...
![alt text](img/anket_duzenle.png "Anket Düzenle")
...
![alt text](img/sistem_kullanicilari.png "Kullanıcı Listesi")
...
![alt text](img/surecler.png "Süreç Listesi")
...
![alt text](img/goc_takip.png "Göç Takip Merkezi")
...
![alt text](img/goc_durumu.png "Göç Durumu")
...
![alt text](img/sorun_izleme.png "Sorun İzleme")
...
![alt text](img/goc_planlama.png "Göç Planlama")
